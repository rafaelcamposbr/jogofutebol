...
type SquadPlayer = {
  ...
  current_overall: number; public_potential_band: string; dynamic: null | { morale: number; fatigue: number; physical_condition: number; form_rating: number; injury_status: string; suspension_status: string };
